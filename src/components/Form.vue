<template>
  <div class="form__container">
    ...
    <form @submit.prevent="$emit('submit')" class="form">
      ...
      <div class="form__checks" v-if="is_with_checks">
        <slot name="checks"></slot>
      </div>
      <SecondaryButton type="submit" class="form__button">
        <slot name="button-text" class="form__container__inputs">Отправить</slot>
      </SecondaryButton>
    </form>
  </div>
</template>
