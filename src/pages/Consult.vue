<template>
  <main class="page consult-page">
    ...
    <form @submit.prevent="send" class="consult-page__form">
      <div class="consult-page__form__row">
        <label for="consult-name" class="consult-page__form__field">
          <input v-model="form.name.value" class="consult-page__form__input body" id='consult-name' type="text"
        ...
        <label for="consult-company" class="consult-page__form__field">
          <input v-model="form.company.value" class="consult-page__form__input body" id='consult-company' type="text"
      ...
      <div class="consult-page__form__row">
        <label for="consult-phone" class="consult-page__form__field">
          <input v-model="form.phone.value" class="consult-page__form__input body" id='consult-phone' type="text"
                 placeholder="????????"/>
        ...
        <label for="consult-email" class="consult-page__form__field">
          <input v-model="form.email.value" class="consult-page__form__input body" id='consult-email' type="text"
                 placeholder="Email"/>
    ...
    <!--    --------------------------------------------------------------------   -->
    <transition name="opacity"><template>
      <main class="page consult-page">
        <h4 class="consult-page__title">
          Напишите нам, если вам нужна консультация
        </h4>
