<template>
  ...
  <swiper
      ...
      class="mySwiper"
  >
    <swiper-slide v-for="(training_item, index) in 10" :key="`training-item-${index}`" class="card">
      <p class="card__type body">кейс</p>
      <div class="card__content">
        <h2 class="card__content__title" :class="active_index===index?'heading_4':'heading_5'">ИСПОЛЬЗОВАНИЕ МЕТОДА LEGO
          SERIOUS
          PLAY</h2>
